...
//만들어지는 함수 render에 인자 is_red 추가하였음.
Graph_lib::Lines* Mesh::render(Graph_lib::Window* wnd, const Matrix4x4& mat_camera, bool is_culling_enabled/*=false*/,Graph_lib::Color color)
{
